...
public class Google_existing_user_sign_in extends Set {
	...
	public void user_click_on_sign_in_with_google_plus_button_old_gmail() throws InterruptedException  {
	    ...
	    next_1.click();
	    Thread.sleep(2000);
	    WebElement gmail_pass = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".btn btn-block btn-social btn-google social-btn > div:nth-child(1) > input:nth-child(1)")));
	    Thread.sleep(2000);
